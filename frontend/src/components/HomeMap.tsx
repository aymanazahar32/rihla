...
export function HomeMap({ masjids, onMasjidClick, height = "260px" }: Props) {
  ...
  // Place masjid markers whenever map is ready or masjids data changes
  useEffect(() => {
  ...
  }, [masjids, mapReady, onMasjidClick]);
